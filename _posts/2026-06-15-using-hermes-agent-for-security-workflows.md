...
**Constraint:** GPT-class models exploit CVEs at eighty-seven percent success from descriptions alone [source](https://arxiv.org/abs/2404.08144). Triage agents must be **read-only**; never grant them production system access.
...
**Constraint:** Seventy-two percent of enterprises use AI for code generation, but eighty-three percent ship without adequate AppSec controls [source](https://checkmarx.com/learn/ai-security/2025-trends-on-ai-security-how-appsec-must-evolve-with-the-ai-shifted-sdlc/). In the pilot, the agent caught eighty-five net-new high and critical vulnerabilities that both the static analysis tools and manual review had missed.
...
**Constraint:** Treat every fetched document as a **prompt injection surface**. CVE-2025-32711 (EchoLeak, CVSS 9.3) demonstrated that a single crafted email could cause M365 Copilot to silently exfiltrate internal files and data across Microsoft 365 services with zero user interaction [source](https://arxiv.org/abs/2509.10540) CVSS score via NVD. Unit 42 documents **twenty-two active evasion techniques** in the wild, including zero-font text, off-screen positioning, Unicode zero-width characters, and Base64 encoding [source](https://unit42.paloaltonetworks.com/ai-agent-prompt-injection/).
...
### Prompt Injection
Any file an agent reads is an attack surface. CVE-2025-32711 showed that a single crafted email can cause a Copilot agent to silently exfiltrate data [source](https://arxiv.org/abs/2509.10540). AI-generated security findings now routinely include hallucinated endpoints, wrong parameters, and cargo-culted headers. GreyNoise Labs documented AI-generated PoCs targeting Cisco ISE that used completely wrong API paths [source](https://www.labs.greynoise.io/grimoire/2025-07-30-ai-poc/).
...
### Automation Bias
**Forty-seven percent of security analysts** accept AI alerts without verification; thirty-seven percent exhibit confirmation bias [source](https://doi.org/10.1145/3759260) [source](Tilbury & Flowerday, MDPI Computers 2024, https://www.mdpi.com/2073-431X/13/7/165). When the noise floor rises, humans stop listening.
