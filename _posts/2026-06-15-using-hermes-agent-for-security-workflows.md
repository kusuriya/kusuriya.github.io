...
The numbers on defense are just as sobering. The ISC2 2024 Cybersecurity Workforce Study estimates **4.76 million unfilled security roles worldwide** [source: https://www.isc2.org/Research/Workforce-Study]. SOCs process an average of **4,484 alerts per day** [source: Tilbury & Flowerday, MDPI Computers 2024, https://www.mdpi.com/2073-431X/13/7/165], and seventy-one percent of analysts report burnout [source: Tines Voice of the SOC Analyst, https://www.tines.com/reports/voice-of-the-soc-analyst/]. AI-assisted developers ship code three to four times faster, often without adequate AppSec controls [source: Checkmarx, "2025 Trends on AI Security," https://checkmarx.com/learn/ai-security/2025-trends-on-ai-security-how-appsec-must-evolve-with-the-ai-shifted-sdlc/; https://labs.cloudsecurityalliance.org/research/csa-research-note-ai-generated-code-vulnerability-surge-2026/]; the resulting security findings surge has been measured at **10× in some enterprises** [source: https://labs.cloudsecurityalliance.org/research/csa-research-note-ai-generated-code-vulnerability-surge-2026/].
...
**Persistent memory across sessions.** Hermes stores cross-session memory via pluggable backends (built-in SQLite, Honcho, Mem0). It builds a model of your environment, preferences, and workflows, which means you spend less time repeating setup context [source: https://hermes-agent.nousresearch.com/docs/user-guide/features/memory/].
...
**Constraint:** GPT-class models exploit CVEs at eighty-seven percent success from descriptions alone [source: arXiv:2404.08144]. Triage agents must be **read-only**; never grant them production system access.
...
**Constraint:** Seventy-two percent of enterprises use AI for code generation, but eighty-three percent ship without adequate AppSec controls [source: Checkmarx AI Security 2025, https://checkmarx.com/learn/ai-security/2025-trends-on-ai-security-how-appsec-must-evolve-with-the-ai-shifted-sdlc/]. In the pilot, the agent caught eighty-five net-new high and critical vulnerabilities that both the static analysis tools and manual review had missed.
...
**Constraint:** Treat every fetched document as a **prompt injection surface**. CVE-2025-32711 (EchoLeak, CVSS 9.3) demonstrated that a single crafted email could cause M365 Copilot to silently exfiltrate internal files and data across Microsoft 365 services with zero user interaction [source: arXiv:2509.10540; CVSS score via NVD]. Unit 42 documents **twenty-two active evasion techniques** in the wild, including zero-font text, off-screen positioning, Unicode zero-width characters, and Base64 encoding [source: https://unit42.paloaltonetworks.com/ai-agent-prompt-injection/].
...
**Constraint:** Early results are promising — the agent is surfacing insights and data relationships faster than a human could make the connections. But this is still a read-only data layer, not a playbook executor. SOAR black-box automation produces lower-quality reports than manual analysis [source: Tilbury & Flowerday 2024]. Before any automated containment, human-in-the-loop checkpoints are mandatory. The long-term path is toward playbook execution with kanban gates, but for now the scope is deliberately narrow: gather, correlate, surface. Let the human decide what to do with it.
...
### Prompt Injection
Any file an agent reads is an attack surface. CVE-2025-32711 showed that a single crafted email can cause a Copilot agent to silently exfiltrate data [source: arXiv:2509.10540]. AI-generated security findings now routinely include hallucinated endpoints, wrong parameters, and cargo-culted headers. GreyNoise Labs documented AI-generated PoCs targeting Cisco ISE that used completely wrong API paths [source: https://www.labs.greynoise.io/grimoire/2025-07-30-ai-poc/].

OWASP's guidance is blunt: no foolproof fix exists [source: https://genai.owasp.org/llm-top-10/]. Run intel parsing in sandboxed terminals (`docker` or `modal`). Strip active content from documents before ingestion. Monitor for anomalous outbound connections.

### Automation Bias
**Forty-seven percent of security analysts** accept AI alerts without verification; thirty-seven percent exhibit confirmation bias [source: ACM DOI:10.1145/3759260; Tilbury & Flowerday, MDPI Computers 2024, https://www.mdpi.com/2073-431X/13/7/165]. When the noise floor rises, humans stop listening.
...
Injecting **five malicious texts** into a knowledge database with millions of texts achieves roughly ninety percent targeted attack success [source: PoisonedRAG, USENIX Security 2025, https://arxiv.org/abs/2402.07867]. AGENTPOISON achieves greater than eighty percent attack success rate via constrained optimization on agent memory [source: Chen et al., NeurIPS 2024, arXiv:2407.12784].
...
**Eighty-two percent of enterprises** have discovered unknown AI agents in the past year; only **twenty-one percent** have formal decommissioning processes [source: Cloud Security Alliance, "Autonomous but Not Controlled: AI Agent Incidents Now Common in Enterprises" (Apr 2026), https://cloudsecurityalliance.org/artifacts/autonomous-but-not-controlled-ai-agent-incidents-now-common-in-enterprises]. The Morris II worm demonstrated that self-propagating agents require no code exploit [source: arXiv:2403.02817]; as one survey put it, in the agentic supply chain, context is code [source: arXiv:2602.19555].
...
1. ISC2 — "Cybersecurity Workforce Study 2024" (2024). https://www.isc2.org/Research/Workforce-Study
2. Tilbury, A. & Flowerday, S. — "The Effects of Alert Fatigue on SOC Analysts" (MDPI Computers 2024). https://www.mdpi.com/2073-431X/13/7/165
3. Checkmarx — "2025 Trends on AI Security: How AppSec Must Evolve with the AI-Shifted SDLC" (Sep 2025). https://checkmarx.com/learn/ai-security/2025-trends-on-ai-security-how-appsec-must-evolve-with-the-ai-shifted-sdlc/
4. Cloud Security Alliance — "Vibe Coding's Security Debt: The AI-Generated CVE Surge" (Apr 2026). https://labs.cloudsecurityalliance.org/research/csa-research-note-ai-generated-code-vulnerability-surge-2026/
5. Digital Applied — "OpenClaw vs Hermes vs Codex CLI: 2026 Coding Agent Benchmark" (2026). https://www.digitalapplied.com/blog/openclaw-hermes-codex-cli-coding-agent-benchmark-2026
6. Hermes Agent Documentation — https://hermes-agent.nousresearch.com/docs/
7. NousResearch/hermes-agent GitHub — https://github.com/nousresearch/hermes-agent
8. OWASP Gen AI Top 10 (2025). https://genai.owasp.org/llm-top-10/
9. arXiv:2509.10540 — EchoLeak / CVE-2025-32711 (2025).
10. arXiv:2601.20727 — Ojewale et al., Audit Trail Requirements (2026).
11. arXiv:2602.19555 — Jiang et al., Agentic AI Attack Surface (2026).
12. arXiv:2403.02817 — Nassi et al., Morris II Worm (2024).
13. ACM DOI:10.1145/3759260 — Hagen et al., Automation Bias in SOCs (2025).
14. Unit 42 — "AI Agent Prompt Injection Evasion Techniques" (Mar 2026). https://unit42.paloaltonetworks.com/ai-agent-prompt-injection/
15. Secure.com — "AI Didn't Just Find More Bugs, It Broke the System for Tracking Them" (2026). https://www.secure.com/blog/cybersecurity/ai-didnt-just-find-more-bugs-it-broke-the-system-for-tracking-them
16. GreyNoise Labs — "The PoC Pollution Problem" (Jul 2025). https://www.labs.greynoise.io/grimoire/2025-07-30-ai-poc/
17. Drata — "Building Smarter AI Security Research" (Apr 2026). https://drata.com/blog/building-smarter-ai-security-research
18. RedMonk — "AI Slop & the Vulnerability Treadmill" (May 2026). https://redmonk.com/kholterhoff/2026/05/05/ai-slop-vulnerability-treadmill/
19. CyberScoop — "AI Might Cut False Positives, But It Won't Stop the Slop" (2026). https://cyberscoop.com/ai-vulnerability-reporting-bug-bounty-noise/
20. Tines — "Voice of the SOC Analyst" (2022). https://www.tines.com/reports/voice-of-the-soc-analyst/
21. arXiv:2404.08144 — GPT-class CVE exploitation success rates (2025).
22. PoisonedRAG — Zou et al., "PoisonedRAG: Knowledge Corruption Attacks to Retrieval-Augmented Generation" (USENIX Security 2025). https://arxiv.org/abs/2402.07867
23. ENISA — "European Vulnerability Database (EUVD)" (live since May 13, 2025). https://euvd.enisa.europa.eu/
24. VulnCheck — "Does ENISA EUVD live up to all the hype?" (May 2025). https://www.vulncheck.com/blog/enisa-euvd
25. Chen et al. — "AgentPoison: Red-teaming LLM Agents via Poisoning Memory or Knowledge Bases" (NeurIPS 2024). https://arxiv.org/abs/2407.12784
26. Cloud Security Alliance — "Autonomous but Not Controlled: AI Agent Incidents Now Common in Enterprises" (Apr 2026). https://cloudsecurityalliance.org/artifacts/autonomous-but-not-controlled-ai-agent-incidents-now-common-in-enterprises
